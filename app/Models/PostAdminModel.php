        ...
        if (!empty($array)) {
            ...
            foreach ($array as $item) {
                if ($i == $index) {
                    ...
                    $data['pre_title'] = getCSVInputValue($item, 'pre_title');
                    ...
                    $data['image_alt'] = getCSVInputValue($item, 'image_alt');
                    $data['show_item_numbers'] = 0;
                    $data['created_at'] = date('Y-m-d H:i:s');
                    //download image
