...
class HomeController extends BaseController
{
    ...
    public function index()
    {
        ...
        // limit latest posts on homepage (classic theme) to max 4 items
        $data['latestPosts'] = getLatestPosts(4);
        ...
        // show at most 4 latest posts on homepage
        $data['limitLoadMorePosts'] = 4;
