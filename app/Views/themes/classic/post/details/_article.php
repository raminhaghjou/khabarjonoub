            ...
            <div class="show-on-page-load">
                <div id="post-detail-slider" class="post-detail-slider">
                    <div class="post-detail-slider-item">
                        <img src="<?= getPostImage($post, 'default'); ?>" class="img-responsive center-image" alt="<?= esc(!empty($post->image_alt) ? $post->image_alt : $post->title); ?>"/>
                    ...
                    <?php foreach ($postImages as $image):
                        ...
                        <div class="post-detail-slider-item">
                            <img src="<?= $imgBaseURL . esc($image->image_default); ?>" class="img-responsive center-image" alt="<?= esc(!empty($post->image_alt) ? $post->image_alt : $post->title); ?>"/>
                        </div>
                    <?php endforeach; ?>
                </div>
