        ...
        <div class="row footer-widgets">
            ...
            <div class="col-sm-4 col-xs-12">
                <div class="footer-widget f-widget-random">
                    <div class="col-sm-12">
                        <div class="row">
                            <h4 class="title"><?= trans("most_viewed_posts") ?: 'پربازدیدترین مطالب یک ماه اخیر'; ?></h4>
            ...
            <div class="col-sm-4 col-xs-12">
                ...
                <?php endif; ?>
		<div id="div_eRasanehTrustseal_85441"></div>
		<script src="https://trustseal.e-rasaneh.ir/trustseal.js"></script>
		<script>eRasaneh_Trustseal(85441, false);</script>
            </div>
        </div>
