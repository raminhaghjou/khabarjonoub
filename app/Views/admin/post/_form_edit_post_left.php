<div class="box">
    ...
    <div class="box-body">
        ...
        <div class="form-group">
            <label class="control-label"><?= trans('pre_title') ?: 'روتیتر'; ?></label>
            <input type="text" class="form-control" name="pre_title" placeholder="<?= trans('pre_title') ?: 'روتیتر'; ?>" value="<?= esc($post->pre_title ?? ''); ?>">
            <small class="text-muted"><?= trans('pre_title_exp') ?: 'متنی که قبل از تیتر اصلی نمایش داده می‌شود (اختیاری)'; ?></small>
        </div>
