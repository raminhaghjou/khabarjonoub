    ...
    <div class="box-body">
        <div class="form-group m-0">
            <?php if (!empty($post)):
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <label class="control-label"><?= trans('image_alt') ?: 'Alt تصویر (سئو)'; ?></label>
                        <input type="text" class="form-control" name="image_alt" placeholder="<?= trans('image_alt') ?: 'Alt تصویر (سئو)'; ?>" value="<?= isset($post->image_alt) ? esc($post->image_alt) : ''; ?>">
                        <small class="text-muted"><?= trans('image_alt_exp') ?: 'فقط در کد HTML برای موتورهای جستجو؛ روی صفحه نمایش داده نمی‌شود.'; ?></small>
                    </div>
                </div>
            <?php else: ?>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <label class="control-label"><?= trans('image_alt') ?: 'Alt تصویر (سئو)'; ?></label>
                        <input type="text" class="form-control" name="image_alt" placeholder="<?= trans('image_alt') ?: 'Alt تصویر (سئو)'; ?>" value="<?= old('image_alt'); ?>">
                        <small class="text-muted"><?= trans('image_alt_exp') ?: 'فقط در کد HTML برای موتورهای جستجو؛ روی صفحه نمایش داده نمی‌شود.'; ?></small>
                    </div>
                </div>
            <?php endif; ?>
